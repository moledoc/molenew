...
if [ -x /usr/bin/dircolors ]; then
    ...
    alias grep='grep --color=auto -I --exclude=tags --exclude-dir=.git'
    alias fgrep='fgrep --color=auto -I --exclude=tags --exclude-dir=.git'
    alias egrep='egrep --color=auto -I --exclude=tags --exclude-dir=.git'
fi
